...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-freesurferformats-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-freesurferformats-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-freesurferformats
# for installing globally
pixi global install r-freesurferformats
```
...
It is possible to list all of the versions of `r-freesurferformats` available on your platform:
...
```
pixi search r-freesurferformats --channel conda-forge
```
